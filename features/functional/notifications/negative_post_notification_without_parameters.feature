...
Feature: Negative responses after making a post request
  ...
  Scenario Outline: Send a new notification without parameter required
    ...
    Examples:
      ...
      | "channelId": $id,   | "priority" : "NORMAL", |                              | "subject" : "Test", | "content" : "A testing message from notifier" | {"field": "recipients","code": "NotEmpty","defaultMessage": "may not be empty"},{"field": "recipients","code":"recipients.valid","defaultMessage": null}                                                                                                                                                          |
      | "channelId": $id,   | "priority" : "NORMAL", | "recipients" : ["#general"], | "subject" : "Test"  |                                               | {"field": "content","code": "content.required","defaultMessage": null}                                                                                                                                                                                                                                            |
